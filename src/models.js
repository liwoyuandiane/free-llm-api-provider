...
const sources = {
  ...
  replicate: { name: 'Replicate', url: 'https://api.replicate.com/v1/chat/completions', models: replicate },
  ...
  minimax: { name: 'MiniMax', url: 'https://api.minimax.chat/v1/chat/completions', models: [] },
